...
<body>
    ...
    <div class="p-5 mt-5 bg-light rounded-3 container">
        ...
        <div class="container-fluid py-5 d-flex justify-content-evenly">
            <a href="<?= url("listar/aluno")?>" class="btn btn-outline-danger btn-lg py-2 px-10 fs-3 rounded-circle">
            <i class="fas fa-user-graduate"></i> 
                <p>Aluno</p>
            </a>
            <a href="<?= url("listar/escola")?>" class="btn btn-outline-danger btn-lg py-2 px-10 fs-3 rounded-circle">
                <i class="fas fa-school"></i>
                <p>Escola</p>
            </a>
            <a href="<?= url("listar/matricula")?>" class="btn btn-outline-danger btn-lg py-2 px-10 fs-3 rounded-circle">
