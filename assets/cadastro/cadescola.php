...
<body>
    ...
    <div class="container my-5 w-50">
        <form action="<?= url("cadastrar/escola/func_cadescola")?>" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-10">
                    <input type="url" name="site" id="site" class="form-control" placeholder="https://www.site.com">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-10">
                    <input type="tel" pattern="[0-9]{2} [0-9]{4}-[0-9]{4}" name="telefone" id="telefone" class="form-control" placeholder="Formato: 15 9999-9999">
                </div>
